	...
	<layout>
        <div class="banner full-height dashboard" :style="user_background">
            <div class="row">
                ...
                <draggable v-model="column_a" :options="{ group:'people', disabled: draggable_disabled }" @change="setLayoutChanged" class="drag col s12 m6 l6 xl3" :class="{ draggable: !draggable_disabled }">
                ...
                <draggable v-model="column_b" :options="{ group:'people', disabled: draggable_disabled }" @change="setLayoutChanged" class="drag col s12 m6 l6 xl3" :class="{ draggable: !draggable_disabled }">
                ...
                <draggable v-model="column_c" :options="{ group:'people', disabled: draggable_disabled }" @change="setLayoutChanged" class="drag col s12 m6 l6 xl3" :class="{ draggable: !draggable_disabled }">
                ...
                <draggable v-model="column_d" :options="{ group:'people', disabled: draggable_disabled }" @change="setLayoutChanged" class="drag col s12 m6 l6 xl3" :class="{ draggable: !draggable_disabled }">
